...
void cleanup_and_exit(int signal) {
    ...
    printf("ustawiono na low cleanup"); 
    exit(0);
}


int main(int argc, char *argv[]) {
    char* currentDirection = "unknown"; // Zmienna do przechowywania obecnego kierunku
    ...
    if (strcmp(argv[1], "go") == 0) {
        ...
        currentDirection = "go"; // Ustawiamy obecny kierunek
    } else if (strcmp(argv[1], "back") == 0) {
        //digitalWrite(PIN_DIR_RIGHT, HIGH);
        //digitalWrite(PIN_DIR_LEFT, LOW);
        currentDirection = "back"; // Ustawiamy obecny kierunek
    } else if (strcmp(argv[1], "left") == 0) {
        //digitalWrite(PIN_DIR_RIGHT, HIGH);
        //digitalWrite(PIN_DIR_LEFT, HIGH);
        currentDirection = "left"; // Ustawiamy obecny kierunek
    } else if (strcmp(argv[1], "right") == 0) {
        //digitalWrite(PIN_DIR_RIGHT, LOW);
        //digitalWrite(PIN_DIR_LEFT, LOW);
        currentDirection = "right"; // Ustawiamy obecny kierunek
    }
